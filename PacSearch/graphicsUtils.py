...
'''The def below used to read 
def keys_pressed(d_o_e=tkinter.tkinter.dooneevent,
                 d_w=tkinter.tkinter.DONT_WAIT):

but JSK changed it to the def below based on a suggestion from 
https://stackoverflow.com/questions/7714229/tkinter-woes-when-porting-2-x-code-to-3-x-tkinter-module-attribute-doesnt-ex/7714643#7714643
'''
...
'''
 JSK See note above also changed the def below
...
'''
JSK also changed below, see JSK note above
